...
mongoose.connect('mongodb+srv://tameem:91i2ta@cluster0-i1pux.mongodb.net/test?retryWrites=true',{useNewUrlParser: true});
...
app.get('/login', (req,res)=>{
    ...
    users.findOne({username: 'tameem6', password : 'wxyz'}, (err,user) => {
